...
class Migrator:
    ...
    def check_for_migrations(cls):
        ...
        files_to_migrate_sorted = sorted(
            files_to_migrate_prioritized, key=lambda x: x[1])
    ...
    def make_migrations(cls):
        ...
        for sql_file in migration_files:
            ...
            migration_data = {'upgrade': str(sqlparse.format(upgrade, strip_comments=True)), 'downgrade': str(
